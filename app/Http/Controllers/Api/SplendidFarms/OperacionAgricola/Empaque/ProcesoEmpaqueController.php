...
class ProcesoEmpaqueController extends Controller
{
    private array $eagerLoad = [
        'entity:id,name,code',
        'recepcion:id,folio_recepcion,fecha_recepcion,cantidad_recibida,peso_bascula,peso_recibido_kg,salida_campo_id,variedad_id,tipo_carga_id,lote_producto_terminado',
